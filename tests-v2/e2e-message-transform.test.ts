...
import { createChatMessageTransformHandler } from "../lib-v2/hooks"
import { Logger } from "../lib-v2/logger"
import { createSessionState, saveSessionState, type WithParts, type SessionState } from "../lib-v2/state"
import { isSyntheticMessage } from "../lib-v2/messages/query"
...
test("state persistence: session state survives save/load round-trip", async () => {
    ...
    const { loadSessionState } = await import("../lib-v2/state/persistence")
