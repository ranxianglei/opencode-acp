# WORKLOG: Release v1.12.2

## Commits

| Commit | Description |
|--------|-------------|
| `2026-07-14` | release: v1.12.2 — bump version, changelog, devlog |

## Changes

### Version Bump
- `package.json`: 1.12.1 → 1.12.2

### Changelog
- `README.md`: Added v1.12.2 entry under "## Changelog"
- `README.zh-CN.md`: Added v1.12.2 entry under "## 更新日志"

### Devlog
- `devlog/2026-07-14_release-v1.12.2/REQ.md` — release requirements
- `devlog/2026-07-14_release-v1.12.2/WORKLOG.md` — this file
...
## Post-Merge
- `release.yml` will auto-tag `v1.12.2`, build, test, publish to npm, create GitHub Release
