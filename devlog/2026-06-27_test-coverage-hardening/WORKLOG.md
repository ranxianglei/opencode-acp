...
**Modules NOT tested:** config.ts merge logic (8th Tier 1 module) — filesystem-dependent, reads from 3 config layers. Config _validation_ already covered by config-validation.test.ts.
